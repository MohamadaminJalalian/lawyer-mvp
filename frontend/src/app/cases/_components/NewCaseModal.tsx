            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="rounded-xl border border-[#E4E1D8] bg-[#FBFAF7] p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xs text-[#8C8A80]">
                    {values.opponentNames.filter((name) => name.trim()).length} نفر
                  </span>
                </div>
                <div className="space-y-2">
              ...
              <div>
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-10 h-10 rounded-lg flex items-center justify-center ${values.isUrgent ? "bg-[#FFF1F1] text-[#C0392B]" : "bg-[#F7F4EC] text-[#8C8A80]"}`}
                    >
                      <Star
                        size={20}
