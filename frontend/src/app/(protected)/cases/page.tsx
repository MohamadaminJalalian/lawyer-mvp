...
<<<<<<< HEAD:frontend/src/app/(protected)/cases/page.tsx
      <div className="mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2.5 mb-4">
          <div className="relative w-full sm:w-93 sm:flex-none">
            <input
              type="text"
              value={searchTerm}
...
<<<<<<< HEAD:frontend/src/app/(protected)/cases/page.tsx
        ...
        <div className="hidden sm:block mx-auto bg-white border border-[#E4E1D8] rounded-xl overflow-hidden">
...
<<<<<<< HEAD:frontend/src/app/(protected)/cases/page.tsx
                    ...
                    <td className="px-2 py-3">
                      <span
                        className={`px-2.5 py-1 rounded-full text-xs ${statusStyles[caseItem.status]
                          }`}
                      >
...
<<<<<<< HEAD:frontend/src/app/(protected)/cases/page.tsx
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span
                      className={`px-2.5 py-0.5 rounded-full text-xs ${statusStyles[caseItem.status]
                        }`}
                    >
                      {statusLabels[caseItem.status]}
                    </span>
